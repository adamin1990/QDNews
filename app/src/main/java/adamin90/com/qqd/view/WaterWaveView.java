...
/**
 * Created by LiTao on 2015-12-01-17:45.
 * Company: QD24so
...
public class WaterWaveView extends View {
    ...
    private String flowNum = "悦读FM";
    private String flowLeft = "倾听文字的声音";
    ...
    private void init(Context context) {
        ...
        downPaint = new Paint();
        downPaint.setStrokeWidth(1.0F);
        downPaint.setColor(Color.WHITE);
        downPaint.setAlpha(50);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        RectF oval = new RectF(mScreenWidth / 4, mScreenHeight / 4,
                mScreenWidth * 3 / 4, mScreenHeight * 3 / 4 );
        canvas.drawArc(oval, startAngle, sweepAngle, false, downPaint);
        ...
        while (startX < endX) {
            ...
            Timber.e("startX:"+startX+"endX:"+endX+"startY:"+startY+"endY:"+top+"screenwith:"+mScreenWidth+"screenheight:" +
                    mScreenHeight);
